 ...
 */
@Data
@ApiModel(value = "值班计划信息")
public class DutyPlanDTO extends TransferObject<DutyPlan> {
	...
	private String id;
	// 值班编号
	@ApiModelProperty(value = "值班计划的编号", required = true)
	...
	// 值班内容
	@ApiModelProperty(value = "值班内容", required = true)
	...
	@ApiModelProperty(value = "间隔天数", required = true) // 间隔天数
